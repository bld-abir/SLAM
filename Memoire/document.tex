...
Considérons un robot se déplaçant dans un environnement inconnu, en observant un certain nombre d'amers grâce à un capteur embarqué sur le robot. La figure \ref{fig:2.2.3.1} montre une illustration du problème.
\begin{figure}[h]
	\centering
...
\begin{tabular}{|l|l|l|}
	...
	\hline 
	\rowcolor[HTML]{57B0B1}
	\cellcolor{beau} & Avantages & Inconvénients \\ 
	\hline 
	\cellcolor{beauc} Filtre de Kalman &  &  \\ 
	\hline 
	\cellcolor{beau} Filtre Particulaire &  &  \\ 
	\hline 
	\cellcolor{beauc} IML &  &  \\ 
	\hline 
	\cellcolor{beau} Scan Matching &  &  \\ 
	\hline 
	\cellcolor{beauc} Scan Matching + Pose Graph &  &  \\ 
	\hline 
	\cellcolor{beau} &  &  \\ 
	\hline 
\end{tabular} 
