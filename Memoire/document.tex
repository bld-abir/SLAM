...
Étant donné que la dérive de la localisation accentue la dérive de la cartographie, on va calculer les poses à partir des données odométrique, et dessiner la carte de l'environnement à partir des des données du télémètre laser et des poses déterminées via l'odométrie. 
